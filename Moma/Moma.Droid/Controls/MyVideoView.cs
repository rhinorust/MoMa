        ...
        private void Init()
        {
            ...
            Task.Run(async () => {
                while (true && this._Token.Token.IsCancellationRequested == false)
                {
                    ...
                    if (this._HasEnded)
                    {
                        this.ParentElement.State = Moma.Library.VideoState.ENDED;
                        this.ParentElement.Info = new VideoData
                        {
                            State = Moma.Library.VideoState.ENDED,
                    ...
                    else if (this.ParentElement.State != VideoState.ENDED)
                    {
                        if (this.IsPlaying)
                        {
                            this.ParentElement.State = Moma.Library.VideoState.PLAY;
                        }
                        else if (this.ParentElement.State != VideoState.PAUSE)
                        {
                            this.ParentElement.State = Moma.Library.VideoState.STOP;
                        }
